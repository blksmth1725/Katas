...
const fireAndFury = (tweet) => {
  let fire = "FIRE";
  let fury = "FURY";
  const splitStr = tweet.includes("FIRE");
  return splitStr;
};

console.log(fireAndFury("FURYFIREFIREFIREYYFIREYYFIRE"));
console.log(fireAndFury("FIREFURYYYFIREYYFIREFIREFIREFURYFIRE"));
console.log(fireAndFury("FIREFURYYYFIREFURYFURYYYFIRE"));
console.log(fireAndFury("FURYYYFIREYYFURYFURYFURYFIRE"));
console.log(fireAndFury("FIREFIRFURYYYFIREYYFURYFIRE"));
